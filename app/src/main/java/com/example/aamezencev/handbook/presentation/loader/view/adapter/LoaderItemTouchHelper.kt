...
class LoaderItemTouchHelper(dragDirs: Int,
    ...
    override fun onSelectedChanged(viewHolder: RecyclerView.ViewHolder?, actionState: Int) {
        viewHolder?.let {
            val foregroundView = (it as LoaderAdapter.ViewHolder).binding.foregroundView
    ...
    override fun onChildDrawOver(c: Canvas?,
        ...
        val foregroundView = (viewHolder as LoaderAdapter.ViewHolder).binding.foregroundView
